            ...
            <div class="collapse" id="masterData" style="background-color:#212121;">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                    ...
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title">Semester</span></a>
               </li>
               ...
               <li class="nav-item">
                    ...
                    <i class="fa fa-angle-double-right" style="font-size:20px;color:#fff;"></i> &nbsp;<span class="menu-title"> Perangkat Pembelajaran</span></a>
               </li>
