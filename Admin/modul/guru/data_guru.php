    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <a href="../Report/guru/data_guru.php" class="btn btn-warning text-white pull-right ml-2"><i class="fa fa-print"></i> Cetak</a>
                <a href="?page=guru&act=add" class="btn btn-info text-white pull-right"><i class="fa fa-plus"></i> Add</a>
                <br>
                </p>
